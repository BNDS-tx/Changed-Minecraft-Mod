...
public class ShockWaveAbility extends SimpleAbility {
    ...
    public static void execute(LevelAccessor world, Entity entity) {
        ...
        for (Entity entityiterator : _entfound) {
            if (player != entityiterator && entityiterator instanceof LivingEntity _entity) {
                ...
                if (!_entity.getCommandSenderWorld().isClientSide()) {
    ...
    public Component getAbilityName(IAbstractChangedEntity entity) {
        return Component.translatable("changed.ability.shock_wave");
    }
    ...
    private static final Collection<Component> DESCRIPTION = Collections.singleton(Component.translatable("ability.changed.shock_wave.desc"));
