...
public class AccessorySlotType extends ForgeRegistryEntry<AccessorySlotType> {
    ...
    public TagKey<Item> getItemTag() {
        ...
        itemTagKey = TagKey.create(Registry.ITEM_REGISTRY, ChangedRegistry.ACCESSORY_SLOTS.getKey(this));
        return itemTagKey;
    }
    ...
    public ResourceLocation getNoItemIcon() {
        ...
        noItemIcon = new ResourceLocation(id.getNamespace(), "item/empty_" + id.getPath() + "_slot");
        return noItemIcon;
    }
