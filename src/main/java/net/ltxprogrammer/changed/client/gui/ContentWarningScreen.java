...
public class ContentWarningScreen extends Screen {
    ...
    private static final Component WARNING = new TranslatableComponent("text.changed.warning");
    private static final Component WARNING_CONTENT1 = new TranslatableComponent("text.changed.warning.content1");
    private static final Component WARNING_CONTENT2 = new TranslatableComponent("text.changed.warning.content2");
