...
public class BasicPlayerInfoScreen extends Screen {
    ...
    protected void init() {
        ...
        i += 2;
        this.addRenderableWidget(new AbstractSliderButton(this.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), 150, 20, new TranslatableComponent("changed.config.bpi.size"), bpi.getSizeValueForConfiguration(player)) {
            {
                this.updateMessage();
            }
