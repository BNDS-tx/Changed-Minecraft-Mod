...
public class ChangedBlocks {
    ...
    public static final RegistryObject<CDStack> CD_STACK = registerNoItem("cd_stack", () -> new CDStack(BlockBehaviour.Properties.of(Material.METAL).sound(SoundType.CANDLE).strength(0.2F)));
    ...
    public static final RegistryObject<Computer> COMPUTER = register("computer", () -> new Computer(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).sound(SoundType.METAL).strength(3.0F, 3.0F).lightLevel((state) -> 4)));
    ...
    public static final RegistryObject<DuctBlock> DUCT = register("duct", () -> new DuctBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).sound(SoundType.METAL).strength(3.0F, 3.0F)));
    ...
    public static final RegistryObject<FloorSignBlock> FLOOR_SIGN_ELECTRICAL = register("floor_sign_electrical", () -> new FloorSignBlock(BlockBehaviour.Properties.of(Material.WOOD).sound(SoundType.WOOD)));
    public static final RegistryObject<FloorSignBlock> FLOOR_SIGN_EXIT = register("floor_sign_exit", () -> new FloorSignBlock(BlockBehaviour.Properties.of(Material.WOOD).sound(SoundType.WOOD)));
    public static final RegistryObject<FloorSignBlock> FLOOR_SIGN_WET = register("floor_sign_wet", () -> new FloorSignBlock(BlockBehaviour.Properties.of(Material.WOOD).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<LabTable> LAB_TABLE = register("lab_table", () -> new LabTable(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(3.0F, 5.0F)));
    ...
    public static final RegistryObject<LatexCrystal> LATEX_CRYSTAL = register("latex_crystal", () -> new LatexCrystal(new ImmutableList.Builder<Supplier<EntityType<? extends DarkLatexEntity>>>()
            .add(ChangedEntities.DARK_LATEX_WOLF_PUP::get).build(), ChangedItems.DARK_LATEX_CRYSTAL_FRAGMENT, BlockBehaviour.Properties.of(Material.AMETHYST).sound(SoundType.AMETHYST_CLUSTER).noOcclusion().noCollission().dynamicShape().strength(1.7F, 0.2F)));
    ...
    public static final RegistryObject<LabBlock> WALL_WHITE_CRACKED = register("wall_white_cracked", () -> new LabBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_GRAY).sound(SoundType.STONE).strength(1.2F, 5.2F)));
    ...
    public static final RegistryObject<LabTable> WHITE_LAB_TABLE = register("white_lab_table", () -> new LabTable(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY).sound(SoundType.METAL).requiresCorrectToolForDrops().strength(3.0F, 5.0F)));
    ...
    public static final RegistryObject<SaplingBlock> ORANGE_TREE_SAPLING = register("orange_tree_sapling", () -> new SaplingBlock(new AbstractTreeGrower() {
        @Override
        protected Holder<? extends ConfiguredFeature<?, ?>> getConfiguredFeature(@NotNull Random random, boolean hasFlowers) {
            return BuiltinRegistries.CONFIGURED_FEATURE.getOrCreateHolder(ChangedFeatures.ORANGE_TREE);
        }
