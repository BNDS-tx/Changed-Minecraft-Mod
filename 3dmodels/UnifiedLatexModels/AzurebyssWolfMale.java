...
public class AzurebyssWolfMale<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightEar2 = Head.addOrReplaceChild("RightEar2", CubeListBuilder.create(), PartPose.offset(-3.0F, -7.7F, 0.0F));

		PartDefinition RightEarFur_r1 = RightEar2.addOrReplaceChild("RightEarFur_r1", CubeListBuilder.create().texOffs(86, 35).mirror().addBox(-1.0F, -3.0F, 0.0F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.1F, -0.1F, -1.25F, -0.0226F, -0.0476F, -0.3048F));
		...
		PartDefinition LeftEar2 = Head.addOrReplaceChild("LeftEar2", CubeListBuilder.create(), PartPose.offset(3.0F, -7.7F, 0.0F));

		PartDefinition LeftEarFur_r1 = LeftEar2.addOrReplaceChild("LeftEarFur_r1", CubeListBuilder.create().texOffs(92, 35).addBox(-1.0F, -3.0F, 0.0F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1F, -0.1F, -1.25F, -0.0226F, 0.0476F, 0.3048F));
		...
		PartDefinition cube_r7 = Muscles.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(54, 23).mirror().addBox(0.3F, 0.0F, 0.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.1F)).mirror(false), PartPose.offsetAndRotation(-0.15F, 1.25F, -2.25F, -0.0436F, -0.0087F, 0.0004F));

		PartDefinition cube_r8 = Muscles.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(54, 23).addBox(-3.0F, 0.0F, 0.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-0.15F, 1.25F, -2.25F, -0.0436F, 0.0087F, -0.0004F));
		...
		PartDefinition cube_r12 = Abs.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(60, 27).mirror().addBox(0.25F, -0.5F, 0.2F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offsetAndRotation(0.05F, 2.45F, -2.2F, 0.0F, -0.0087F, 0.0F));

		PartDefinition cube_r13 = Abs.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(54, 24).addBox(-2.25F, -2.0F, 0.2F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.225F)), PartPose.offsetAndRotation(-0.05F, 2.35F, -2.45F, 0.0F, 0.0087F, 0.0F));

		PartDefinition cube_r14 = Abs.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(54, 24).mirror().addBox(0.25F, -2.0F, 0.2F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.225F)).mirror(false), PartPose.offsetAndRotation(0.05F, 2.35F, -2.45F, 0.0F, -0.0087F, 0.0F));
